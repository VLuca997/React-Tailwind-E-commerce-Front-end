...
const Product = ({ product }) => {
    ...
    return (
        <div className=" flex flex-col justify-between border bg-white border-slate-300 rounded-lg shadow-md overflow-hidden group transition transform hover:scale-105">
            <div className=''>
            <div className="w-full h-64 flex justify-center items-center bg-zinc-500">
                <img className="w-full h-full object-contain p-2" src={image} alt={title} />
            </div>
