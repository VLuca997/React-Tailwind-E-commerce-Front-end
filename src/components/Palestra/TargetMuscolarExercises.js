...
const TargetMuscolarExercises = ({ exerciseList: initialExerciseList }) => {
    ...
    return <>
        <div className='flex flex-col mt-10 '>
            <div className="w-100 bg-blue-700 rounded-3xl text-white">

                <div className="mt-4 px-5">
                <div className="text-lg flex flex-row font-semibold mx-5 mb-2 items-center">Esercizi del Gruppo Muscolare:
                    <Select
                        options={targetOptions}
                        value={selectedTarget}
                        onChange={handleTargetChange}
                        placeholder="Scegli il Gruppo Muscolare da Allenare..."
                        className='ml-5 min-w-[200px] text-black'
                    />
                </div>
                    {selectedTarget && (
                        <>
